...
func main() {
	...
	// go run sql2pb.go -go_package ./pb -host localhost -package pb -password root -port 3306 -schema app_order -service_name order -user root > order.proto
	...
	schema := flag.String("schema", "app_order", "the database schema")
